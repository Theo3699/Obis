...
mongoose.connect("mongodb://localhost:27017/salut", {
...
countrySchema.index( { name: 1, year: 1 }, { unique: true } )
...
//punem doua tari cu aceleasi caracteristici
//eroare aruncata: duplicate key error collection: salut.countries index: name_1_year_1 dup key: { name: "franta", year: 2020 }
//imi pune in baza de date numai una dintre cele doua obiecte.
